...
default_parameters = {
	...
	'Identifiers':{
		...
		'step':   {'type':'string', 'default':'', 'title':'Note',    'description':'Personal note for this experiment.'},
	},
	'runConfigs': {
		'GateSweep':{
...
default_schedules = {
	'Gate Sweep':             {"runType": "GateSweep",      "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "step": ""}, "runConfigs": {"GateSweep": {"gateVoltageMinimum": -1, "gateVoltageMaximum": 1, "drainVoltageSetPoint": 0.5, "stepsInVGSPerDirection": 100}}},
	...
	'Noise Collection':       {"runType": "NoiseCollection","Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "step": ""}, "runConfigs": {"NoiseCollection": {"measurementSpeed": 10000, "points": 10000, "gateVoltage": 0, "drainVoltage": 0.5}}},
	'Noise Grid':             {"runType": "NoiseGrid",      "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "step": ""}, "runConfigs": {"NoiseGrid": {"gateVoltages":[], "drainVoltages":[], "groundingTime":0}, "NoiseCollection": {"measurementSpeed": 10000, "points": 10000, "gateVoltage": 0, "drainVoltage": 0.5}}},
	'Inverter Sweep':         {"runType": "InverterSweep",  "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "step": ""}, "runConfigs": {"InverterSweep": {"inputVoltageMinimum": 0, "inputVoltageMaximum": 1, "vddSupplyVoltageSetPoint": 1, "stepsInVINPerDirection": 100}}, "MeasurementSystem": {"systemType": "B2900A (inverter)"}},
	'Inverter Bias':          {"runType": "InverterBias",   "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "step": ""}, "runConfigs": {"InverterBias": {"inputVoltageSetPoint": 0, "vddSupplyVoltageSetPoint": 1.0, "totalBiasTime": 60, "measurementTime":1}}, "MeasurementSystem": {"systemType": "B2900A (inverter)"}},
	'AFM Control':            {"runType": "AFMControl",     "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "step": ""}, "runConfigs": {"AFMControl": {"lines": 3, "scanRate": 1, "napOn": True, "drainVoltageSetPoint": 0.01, "gateVoltageSetPoint": 0, "startOnFrameSwitch": False, "deviceMeasurementSpeed": 60, "XYCableSwap": False}}, "MeasurementSystem": {"systemType": "B2900A (double)"}},
	'SGM Control':            {"runType": "SGMControl",     "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "step": ""}, "runConfigs": {"SGMControl": {"lines": 3, "scanRate": 1, "napOn": True, "drainVoltageSetPoint": 0.01, "gateVoltageSetPoint": 0, "startOnFrameSwitch": False, "complianceCurrent": 0.000001, "deviceMeasurementSpeed": 60, "XYCableSwap": False, "tracesToMeasure": 1, "scans": 1}}, "MeasurementSystem": {"systemType": "B2900A (double)"}},
	'Flow Static Bias':       {"runType": "FlowStaticBias", "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "step": ""}, "runConfigs": {"FlowStaticBias": {"flowDurations": [], "subCycleDurations": [], "cycleCount": 3, "solutions": [], "gateVoltageSetPoint": 0, "drainVoltageSetPoint": 0.5, "measurementTime": 1}}},
	'Multiple Flow Static Biases': {"runType": "AutoFlowStaticBias", "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "step": ""}, "runConfigs": {"AutoFlowStaticBias": {"numberOfFlowStaticBiases": 1, "doInitialGateSweep": True, "applyGateSweepBetweenBiases": False, "numberOfBiasesBetweenIncrements": 1, "biasTimeList": [], "incrementStaticGateVoltage": 0, "incrementStaticDrainVoltage": 0}, "FlowStaticBias": {"flowDurations": [], "subCycleDurations": [], "cycleCount": 3, "solutions": [], "gateVoltageSetPoint": 0, "drainVoltageSetPoint": 0.5, "measurementTime": 1}, "GateSweep": {"gateVoltageMinimum": -1, "gateVoltageMaximum": 1, "drainVoltageSetPoint": 0.5, "stepsInVGSPerDirection": 100}}},
	'CNT Burn Out':           {"runType": "BurnOut",        "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "step": ""}, "runConfigs": {"BurnOut": {"gateVoltageSetPoint": 15, "drainVoltageMaxPoint": 5, "minimumAppliedDrainVoltage": 1.1}}},
	'Multiple CNT Burn Outs': {"runType": "AutoBurnOut",    "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "step": ""}, "runConfigs": {"AutoBurnOut": {"targetOnOffRatio": 80, "limitBurnOutsAllowed": 8}, "BurnOut": {"gateVoltageSetPoint": 15, "drainVoltageMaxPoint": 5, "minimumAppliedDrainVoltage": 1.1}}},
	'Delay':                  {"runType": "Delay",          "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "step": ""}, "runConfigs": {"Delay": {"delayTime": 60}}},
	'PT Sensor':              {"runType": "PTSensor",       "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "step": ""}, "runConfigs": {"PTSensor": {"totalSensingTime": 60}}},
}
