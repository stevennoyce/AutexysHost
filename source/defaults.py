...
default_parameters = {
	...
	'runConfigs': {
		...
		'DrainSweep':{
			...
			'drainVoltageMaximum': 		{'type':'float', 'essential':True, 'units':'V',  'default': 0.1,    'title':'Drain Voltage End',            'description':'Drain voltage final value.'}, 
		...
		'BurnOut':{
			...
			'gateVoltageSetPoint':			{'type':'float', 'essential':True, 'units':'V', 'default': 15.0, 'title':'Gate Voltage',                  'description':''},
		...
		'AutoDrainSweep':{
			...
			'gateVoltageSetPoints':			{'type':'array', 'essential':True, 'units':'V', 'default': [-0.1, 0, 0.1], 'title':'Gate Voltage Set Points', 'description':'List of gate voltage values to do sweeps at.'},
			'delayBetweenSweeps': 			{'type':'float',                   'units':'s', 'default': 2,              'title':'Delay Between Sweeps',    'description':'Delay between each sweep.'},
		...
		'Delay':{
			'dependencies': 			{'ignore':True, 'value':[]},
			'delayTime':				{'type':'int',    'essential':True, 'units':'s', 'default': 30,                       'title':'Delay Time', 'description':'Duration of delay.'}, 
		...
		'RapidBias':{
			...
			'drainVoltageSetPoints':	{'type':'array',  'essential':True, 'units':'V', 'default': [0.01],   		  'title':'Drain Voltage Key Points', 'description':'List of drain voltages that the generated VDS waveform must include.'},
			'gateVoltageSetPoints':		{'type':'array',  'essential':True, 'units':'V', 'default': [0,0.1, 0,0.1,0], 'title':'Gate Voltage Key Points',  'description':'List of gate voltages that the generated VGS waveform must include.'},
		...
		'NoiseCollection':{
			...
			'drainVoltage':				{'type':'float', 'essential':True, 'units':'V',  'default': 0.1,    'title':'Drain Voltage',      'description':'Drain voltage value.'}, 
		},
		'NoiseGrid':{
			...
			'gateVoltages':				{'type':'array', 'essential':True, 'units':'V', 'default': [-0.5,0,0.5],     'title':'Gate Voltages',  'description':''},
