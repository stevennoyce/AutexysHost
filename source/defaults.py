...
default_parameters = {
	...
	'MeasurementSystem':{
		'systemType':				{'type':'choice',             'default':'single', 'title':'System Type',           'description':'The type of system used to capture measurements for this procedure.', 'choices':['single', 'standalone', 'Bluetooth', 'Combo', 'double', 'B29x2A (inverter)', 'Arduino', 'Emulator']},
		'systems': {},
...
default_schedules = {
	...
	'Inverter Sweep':         {"runType": "InverterSweep",  "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "step": 0}, "runConfigs": {"InverterSweep": {"inputVoltageMinimum": 0, "inputVoltageMaximum": 1, "vddSupplyVoltageSetPoint": 1, "stepsInVINPerDirection": 100}}, "MeasurementSystem": {"systemType": "B29x2A (inverter)"}},
	'Inverter Bias':          {"runType": "InverterBias",   "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "step": 0}, "runConfigs": {"InverterBias": {"inputVoltageSetPoint": 0, "vddSupplyVoltageSetPoint": 1.0, "totalBiasTime": 60, "measurementTime":1}}, "MeasurementSystem": {"systemType": "B29x2A (inverter)"}},
