...
default_parameters = {
	...
	'runConfigs': {
		'GateSweep':{
			...
			'stepsInVGSPerDirection': 	{'type':'int', 'units':'#', 'default': 100, 'title':'Steps In VGSPer Direction', 'description':''},
			'pointsPerVGS': 			{'type':'int', 'units':'#', 'default': 1, 'title':'Points Per VGS', 'description':''},
			'gateVoltageRamps':			{'type':'int', 'units':'#', 'default': 2, 'title':'Gate Voltage Ramps', 'description':''},
			...
			'gateVoltageMinimum': 		{'type':'float', 'units':'V', 'default': -1, 'title':'Gate Voltage Minimum', 'description':''},
			'gateVoltageMaximum': 		{'type':'float', 'units':'V', 'default': 1, 'title':'Gate Voltage Maximum', 'description':''} 
		},
		'DrainSweep':{
			'dependencies': 			{'ignore':True, 'value':[]},
			...
			'pointsPerVDS': 			{'type':'int', 'units':'#', 'default':1, 'title':'Points Per VDS', 'description':''},
			'drainVoltageRamps':		{'type':'int', 'units':'#', 'default': 2, 'title':'Drain Voltage Ramps', 'description':''},
			'complianceCurrent':		{'type':'float', 'units':'A', 'default':100e-6, 'title':'Compliance Current', 'description':''},
			'gateVoltageSetPoint':		{'type':'float', 'units':'V', 'default':0, 'title':'Gate Voltage Set Point', 'description':''},
			'drainVoltageMinimum': 		{'type':'float', 'units':'V', 'default':0, 'title':'Drain Voltage Minimum', 'description':''},
			'drainVoltageMaximum': 		{'type':'float', 'units':'V', 'default':0.5, 'title':'Drain Voltage Maximum', 'description':''} 
		},
		'BurnOut':{
			'dependencies':				{'ignore':True, 'value':[]},
			...
			'gateVoltageSetPoint':		{'type':'float', 'units':'V', 'default': 15.0, 'title':'Gate Voltage Set Point', 'description':''},
		...
		'AutoGateSweep':{
			...
			'sweepsPerVDS': 			{'type':'int', 'units':'#', 'default': 5, 'title':'Sweeps Per VDS', 'description':''},
		...
		'Delay':{
			...
			'delayTime':				{'type':'int', 'units':'s', 'default': 240, 'title':'Delay Time', 'description':''} 
		},
		'InverterSweep':{
			'dependencies':				{'ignore':True, 'value':[]},
