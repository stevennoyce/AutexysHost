...
default_parameters = {
	...
	'runConfigs': {
		...
		'ConstantCurrent': {
			...
			'enableSweep':					{'type':'bool',  'essential':True, 			    'default': False, 'title':'Sweep', 							  'description':''},
			'sweepStart':					{'type':'float', 'essential':True, 'units':'V', 'default': 0,     'title':'Sweep Start', 					  'description':''},
			'sweepEnd':						{'type':'float', 'essential':True, 'units':'V', 'default': 1,     'title':'Sweep End', 						  'description':''},
			'sweepSteps':					{'type':'int',   'essential':True, 'units':'#', 'default': 100,   'title':'Steps in Sweep', 				  'description':''},
			'sweepDelayBetweenMeasurements':{'type':'float', 'essential':True, 'units':'s', 'default': 0,     'title':'Delay Between Steps', 			  'description':''},
			'sweepFrequency':				{'type':'float', 'essential':True, 'units':'s', 'default': 60, 	  'title':'Sweep Frequency', 				  'description':''},
		},
		'FourPointProbe': {
			'dependencies':				{'ignore':True, 'value':[]},
		...
		'AutoGateSweep':{
			...
			'drainVoltageSetPoints': 		{'type':'array', 'essential':True, 'units':'V', 'default': [],    'title':'Drain Voltage Set Points', 'description':'List of drain voltage values to do sweeps at. If this list is empty, it defaults to the value provided in "GateSweep."', 'placeholder':'Example: [-1, 0, 0.5]'}, 
		...
		'RapidBias':{
			...
			'complianceCurrent':		{'type':'float',                    'units':'A', 'default': 100e-6,           'title':'Compliance Current',       'description':'Maximum current limit for the SMU.'},
			'averageOverPoints': 		{'type':'int',                      'units':'#', 'default': 1,                'title':'Average Over Points',      'description':'When greater than one, this number of consecutive measurements are averaged together to reduce size of saved data.'},
		...
		'SmallSignal':{
			...
			'gateVoltageSetPoint': 		{'type':'float', 'essential':True, 'units':'V',  'default': 0,      'title':'Gate Voltage DC Offset',         'description':'Gate voltage DC offset value.'},
			'drainVoltageSetPoint':		{'type':'float', 'essential':True, 'units':'V',  'default': 0.5,    'title':'Drain Voltage DC Offset',        'description':'Drain voltage DC offset value.'},
			...
			'periods': 					{'type':'int',                     'units':'#',  'default': 4,      'title':'Periods',                        'description':'Number of signal periods to measure over for each frequency.'},
			'stepsPerPeriod': 			{'type':'int',                     'units':'#',  'default': 25,     'title':'Measurements per Period',        'description':'Number of measurements to take per period of the small-signal waveforms.'},
			'complianceCurrent': 		{'type':'float',                   'units':'A',  'default': 100e-6, 'title':'Compliance Current',             'description':'Maximum current limit for the SMU.'},
			'supplyGateVoltage': 		{'type':'bool',  			                     'default': True,   'title':'Supply Gate Voltage',        	  'description':'When disabled, gate channel enters a high-resistance state to measure the gate voltage.'},
			'supplyDrainVoltage': 		{'type':'bool',  			                     'default': True,   'title':'Supply Drain Voltage',       	  'description':'When disabled, drain channel enters a high-resistance state to measure the drain voltage.'},
		},
	...
	'DeviceCycling':{
		...
		'specificDeviceRange':	{'type':'array',              'default': [],      'title':'Specific Device Range', 'description':'List of specific devices to cycle over.', 'placeholder':'Example: ["1-2", "3-4"]', 'choices':["1-2", "2-3", "3-4", "5-6", "6-7", "7-8", "9-10", "10-11", "11-12", "13-14", "14-15", "15-16", "19-20", "21-22", "27-28", "29-30", "30-31", "31-32", "33-34", "34-35", "35-36", "37-38", "38-39", "39-40", "41-42", "42-43", "43-44", "45-46", "46-47", "47-48", "51-52", "53-54", "59-60", "61-62", "62-63", "63-64"]}, 
	...
	'experimentSubFolder': {'type':'string', 'default':EXPERIMENT_FOLDER_PREFIX, 'title':'Experiment Sub-Folder', 'description':''},
...
default_schedules = {
	'Gate Sweep':             {"runType": "GateSweep",      "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"GateSweep": {"gateVoltageMinimum": -1, "gateVoltageMaximum": 1, "drainVoltageSetPoint": 0.5, "stepsInVGSPerDirection": 100}}},
	'Drain Sweep':            {"runType": "DrainSweep",     "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"DrainSweep": {"drainVoltageMinimum": 0, "drainVoltageMaximum": 1, "gateVoltageSetPoint": 0, "stepsInVDSPerDirection": 100}}},
	'Static Bias':            {"runType": "StaticBias",     "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"StaticBias": {"gateVoltageSetPoint": 0, "drainVoltageSetPoint": 0.5, "totalBiasTime": 60, "measurementTime": 1}}},
	'Constant Current':       {"runType": "ConstantCurrent","Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"ConstantCurrent": {"currentAppliedMilliamps": 0, "currentDuration": 60, "currentDataInterval": 1, "complianceVoltage": 5}}},
	'Multiple Gate Sweeps':   {"runType": "AutoGateSweep",  "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"AutoGateSweep": {"sweepsPerVDS": 3, "drainVoltageSetPoints": []}, "GateSweep": {"gateVoltageMinimum": -1, "gateVoltageMaximum": 1, "drainVoltageSetPoint": 0.5, "stepsInVGSPerDirection": 100}}},
	'Multiple Drain Sweeps':  {"runType": "AutoDrainSweep", "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"AutoDrainSweep": {"sweepsPerVGS": 1, "gateVoltageSetPoints": [-1,0,1]}, "DrainSweep": {"drainVoltageMinimum": 0, "drainVoltageMaximum": 1, "gateVoltageSetPoint": 0, "stepsInVDSPerDirection": 100}}},
	'Multiple Static Biases': {"runType": "AutoStaticBias", "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"AutoStaticBias": {"numberOfStaticBiases": 1, "biasTimeList": [], "gateVoltageSetPointList": [], "drainVoltageSetPointList": []}, "StaticBias": {"gateVoltageSetPoint": 0, "drainVoltageSetPoint": 0.5, "totalBiasTime": 60, "measurementTime": 1}, "GateSweep": {"gateVoltageMinimum": -1, "gateVoltageMaximum": 1, "drainVoltageSetPoint": 0.5, "stepsInVGSPerDirection": 100}}},
	'Rapid Bias':             {"runType": "RapidBias",      "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"RapidBias": {"waveform": "square", "drainVoltageSetPoints": [0.1], "gateVoltageSetPoints": [0, 1, 0, 1, 0], "measurementPoints": [50, 50, 50, 50, 50]}}},
	'Small Signal':           {"runType": "SmallSignal",    "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"SmallSignal": {"gateVoltageSetPoint": 0, "drainVoltageSetPoint": 0.5, "gateVoltageAmplitude": 0.1, "drainVoltageAmplitude": 0.1, "frequencies":[1]}}},
	...
	'Noise Collection':       {"runType": "NoiseCollection","Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"NoiseCollection": {"measurementSpeed": 10000, "points": 10000, "gateVoltage": 0, "drainVoltage": 0.5}}},
	'Noise Grid':             {"runType": "NoiseGrid",      "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"NoiseGrid": {"gateVoltages":[], "drainVoltages":[], "groundingTime":0}, "NoiseCollection": {"measurementSpeed": 10000, "points": 10000, "gateVoltage": 0, "drainVoltage": 0.5}}},
	'Inverter Sweep':         {"runType": "InverterSweep",  "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"InverterSweep": {"inputVoltageMinimum": 0, "inputVoltageMaximum": 1, "vddSupplyVoltageSetPoint": 1, "stepsInVINPerDirection": 100}}, "MeasurementSystem": {"systemType": "B2900A (inverter)"}},
	'Inverter Bias':          {"runType": "InverterBias",   "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"InverterBias": {"inputVoltageSetPoint": 0, "vddSupplyVoltageSetPoint": 1.0, "totalBiasTime": 60, "measurementTime":1}}, "MeasurementSystem": {"systemType": "B2900A (inverter)"}},
	'AFM Control':            {"runType": "AFMControl",     "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"AFMControl": {"lines": 3, "scanRate": 1, "napOn": True, "drainVoltageSetPoint": 0.01, "gateVoltageSetPoint": 0, "startOnFrameSwitch": False, "deviceMeasurementSpeed": 60, "XYCableSwap": False}}, "MeasurementSystem": {"systemType": "B2900A (double)"}},
	'SGM Control':            {"runType": "SGMControl",     "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"SGMControl": {"lines": 3, "scanRate": 1, "napOn": True, "drainVoltageSetPoint": 0.01, "gateVoltageSetPoint": 0, "startOnFrameSwitch": False, "complianceCurrent": 0.000001, "deviceMeasurementSpeed": 60, "XYCableSwap": False, "tracesToMeasure": 1, "scans": 1}}, "MeasurementSystem": {"systemType": "B2900A (double)"}},
	'Flow Static Bias':       {"runType": "FlowStaticBias", "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"FlowStaticBias": {"flowDurations": [], "subCycleDurations": [], "cycleCount": 3, "solutions": [], "gateVoltageSetPoint": 0, "drainVoltageSetPoint": 0.5, "measurementTime": 1}}},
	'Multiple Flow Static Biases': {"runType": "AutoFlowStaticBias", "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"AutoFlowStaticBias": {"numberOfFlowStaticBiases": 1, "doInitialGateSweep": True, "applyGateSweepBetweenBiases": False, "numberOfBiasesBetweenIncrements": 1, "biasTimeList": [], "incrementStaticGateVoltage": 0, "incrementStaticDrainVoltage": 0}, "FlowStaticBias": {"flowDurations": [], "subCycleDurations": [], "cycleCount": 3, "solutions": [], "gateVoltageSetPoint": 0, "drainVoltageSetPoint": 0.5, "measurementTime": 1}, "GateSweep": {"gateVoltageMinimum": -1, "gateVoltageMaximum": 1, "drainVoltageSetPoint": 0.5, "stepsInVGSPerDirection": 100}}},
	'CNT Burn Out':           {"runType": "BurnOut",        "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": ""}, "runConfigs": {"BurnOut": {"gateVoltageSetPoint": 15, "drainVoltageMaxPoint": 5, "minimumAppliedDrainVoltage": 1.1}}},
