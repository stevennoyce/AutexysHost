...
default_parameters = {
	...
	'Identifiers':{
		...
		'note':   {'type':'string', 'default':'', 'title':'Note',    'description':'Personal note for this experiment.'},
	},
	'runConfigs': {
		'GateSweep':{
		...
		'SmallSignal':{
			...
			'drainVoltageSetPoint':		{'type':'float', 'essential':True, 'units':'V',  'default': 0,      'title':'Drain Voltage DC Offset',        'description':'Drain voltage DC offset value.'},
			'gateVoltageAmplitude': 	{'type':'float', 'essential':True, 'units':'V',  'default': 0.5,    'title':'Gate Voltage Amplitude',         'description':'Gate voltage small-signal sinusoidal AC amplitude.'},
			'drainVoltageAmplitude': 	{'type':'float', 'essential':True, 'units':'V',  'default': 0.2,    'title':'Drain Voltage Amplitude',        'description':'Drain voltage small-signal sinusoidal AC amplitude.'},
...
default_schedules = {
	'Gate Sweep':             {"runType": "GateSweep",      "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"GateSweep": {"gateVoltageMinimum": -1, "gateVoltageMaximum": 1, "drainVoltageSetPoint": 0.5, "stepsInVGSPerDirection": 100}}},
	'Drain Sweep':            {"runType": "DrainSweep",     "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"DrainSweep": {"drainVoltageMinimum": 0, "drainVoltageMaximum": 1, "gateVoltageSetPoint": 0, "stepsInVDSPerDirection": 100}}},
	'Static Bias':            {"runType": "StaticBias",     "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"StaticBias": {"gateVoltageSetPoint": 0, "drainVoltageSetPoint": 0.5, "totalBiasTime": 60, "measurementTime": 1}}},
	'Multiple Gate Sweeps':   {"runType": "AutoGateSweep",  "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"AutoGateSweep": {"sweepsPerVDS": 3, "drainVoltageSetPoints": []}, "GateSweep": {"gateVoltageMinimum": -1, "gateVoltageMaximum": 1, "drainVoltageSetPoint": 0.5, "stepsInVGSPerDirection": 100}}},
	'Multiple Drain Sweeps':  {"runType": "AutoDrainSweep", "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"AutoDrainSweep": {"sweepsPerVGS": 1, "gateVoltageSetPoints": [-1,0,1]}, "DrainSweep": {"drainVoltageMinimum": 0, "drainVoltageMaximum": 1, "gateVoltageSetPoint": 0, "stepsInVDSPerDirection": 100}}},
	'Multiple Static Biases': {"runType": "AutoStaticBias", "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"AutoStaticBias": {"numberOfStaticBiases": 1, "biasTimeList": [], "gateVoltageSetPointList": [], "drainVoltageSetPointList": []}, "StaticBias": {"gateVoltageSetPoint": 0, "drainVoltageSetPoint": 0.5, "totalBiasTime": 60, "measurementTime": 1}, "GateSweep": {"gateVoltageMinimum": -1, "gateVoltageMaximum": 1, "drainVoltageSetPoint": 0.5, "stepsInVGSPerDirection": 100}}},
	'Rapid Bias':             {"runType": "RapidBias",      "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"RapidBias": {"waveform": "square", "drainVoltageSetPoints": [0.1], "gateVoltageSetPoints": [0, 1, 0, 1, 0], "measurementPoints": [50, 50, 50, 50, 50]}}},
	'Small Signal':           {"runType": "SmallSignal",    "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"SmallSignal": {"gateVoltageSetPoint": 0, "drainVoltageSetPoint": 0, "gateVoltageAmplitude": 0.5, "drainVoltageAmplitude": 0.2, "frequencies":[1]}}},
	...
	'Noise Collection':       {"runType": "NoiseCollection","Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"NoiseCollection": {"measurementSpeed": 10000, "points": 10000, "gateVoltage": 0, "drainVoltage": 0.5}}},
	'Noise Grid':             {"runType": "NoiseGrid",      "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"NoiseGrid": {"gateVoltages":[], "drainVoltages":[], "groundingTime":0}, "NoiseCollection": {"measurementSpeed": 10000, "points": 10000, "gateVoltage": 0, "drainVoltage": 0.5}}},
	'Inverter Sweep':         {"runType": "InverterSweep",  "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"InverterSweep": {"inputVoltageMinimum": 0, "inputVoltageMaximum": 1, "vddSupplyVoltageSetPoint": 1, "stepsInVINPerDirection": 100}}, "MeasurementSystem": {"systemType": "B2900A (inverter)"}},
	'Inverter Bias':          {"runType": "InverterBias",   "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"InverterBias": {"inputVoltageSetPoint": 0, "vddSupplyVoltageSetPoint": 1.0, "totalBiasTime": 60, "measurementTime":1}}, "MeasurementSystem": {"systemType": "B2900A (inverter)"}},
	'AFM Control':            {"runType": "AFMControl",     "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"AFMControl": {"lines": 3, "scanRate": 1, "napOn": True, "drainVoltageSetPoint": 0.01, "gateVoltageSetPoint": 0, "startOnFrameSwitch": False, "deviceMeasurementSpeed": 60, "XYCableSwap": False}}, "MeasurementSystem": {"systemType": "B2900A (double)"}},
	'SGM Control':            {"runType": "SGMControl",     "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"SGMControl": {"lines": 3, "scanRate": 1, "napOn": True, "drainVoltageSetPoint": 0.01, "gateVoltageSetPoint": 0, "startOnFrameSwitch": False, "complianceCurrent": 0.000001, "deviceMeasurementSpeed": 60, "XYCableSwap": False, "tracesToMeasure": 1, "scans": 1}}, "MeasurementSystem": {"systemType": "B2900A (double)"}},
	'Flow Static Bias':       {"runType": "FlowStaticBias", "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"FlowStaticBias": {"flowDurations": [], "subCycleDurations": [], "cycleCount": 3, "solutions": [], "gateVoltageSetPoint": 0, "drainVoltageSetPoint": 0.5, "measurementTime": 1}}},
	'Multiple Flow Static Biases': {"runType": "AutoFlowStaticBias", "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"AutoFlowStaticBias": {"numberOfFlowStaticBiases": 1, "doInitialGateSweep": True, "applyGateSweepBetweenBiases": False, "numberOfBiasesBetweenIncrements": 1, "biasTimeList": [], "incrementStaticGateVoltage": 0, "incrementStaticDrainVoltage": 0}, "FlowStaticBias": {"flowDurations": [], "subCycleDurations": [], "cycleCount": 3, "solutions": [], "gateVoltageSetPoint": 0, "drainVoltageSetPoint": 0.5, "measurementTime": 1}, "GateSweep": {"gateVoltageMinimum": -1, "gateVoltageMaximum": 1, "drainVoltageSetPoint": 0.5, "stepsInVGSPerDirection": 100}}},
	'CNT Burn Out':           {"runType": "BurnOut",        "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"BurnOut": {"gateVoltageSetPoint": 15, "drainVoltageMaxPoint": 5, "minimumAppliedDrainVoltage": 1.1}}},
	'Multiple CNT Burn Outs': {"runType": "AutoBurnOut",    "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"AutoBurnOut": {"targetOnOffRatio": 80, "limitBurnOutsAllowed": 8}, "BurnOut": {"gateVoltageSetPoint": 15, "drainVoltageMaxPoint": 5, "minimumAppliedDrainVoltage": 1.1}}},
	'Delay':                  {"runType": "Delay",          "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"Delay": {"delayTime": 60}}},
	'PT Sensor':              {"runType": "PTSensor",       "Identifiers": {"user": "", "project": "", "wafer": "", "chip": "", "device": "", "note": ""}, "runConfigs": {"PTSensor": {"totalSensingTime": 60}}},
}
