...
def sendPlot(user, project, wafer, chip, device, experiment, plotType):
	...
	for dynamicModeParameter in ['sweepDirection', 'plotInRealTime', 'timescale', 'boxPlotBarChart', 'enableLegend', 'enableErrorBars', 'enableColorBar', 'enableGradient', 'xlim', 'ylim', 'xscale', 'yscale', 'xticks', 'yticks', 'publication_mode', 'figureSizeOverride', 'colorsOverride', 'legendLoc', 'legendLabels', 'legendTitleOverride']:
