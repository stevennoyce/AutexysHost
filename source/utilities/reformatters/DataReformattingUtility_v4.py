...
def reformat_device(load_directory, save_directory):
		...
		for deviceRun in gateSweepHistory:
			...
			deviceRun['MeasurementSystem']['systems'] = {}
			deviceRun['MeasurementSystem']['systems']['default'] = {
				'uniqueID':'',
				'type':deviceRun['MeasurementSystem']['system'],
				'settings':{}
			}
			del deviceRun['MeasurementSystem']['system']
			del deviceRun['MeasurementSystem']['NPLC']
