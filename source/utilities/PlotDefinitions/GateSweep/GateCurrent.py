...
def plot(deviceHistory, identifiers, mode_parameters=None):
	...
	print(max_current, min_current, abs_max_current)
	...
	for i in range(len(deviceHistory)):
		line = plotGateCurrent(ax, deviceHistory[i], colors[i], direction=mode_parameters['sweepDirection'], scaleYaxisBy=current_scale, lineStyle=None, errorBars=mode_parameters['enableErrorBars'])
