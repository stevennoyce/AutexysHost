...
def plot(deviceHistory, identifiers, mode_parameters=None):
	...
	approx_max_value = (abs_max_current/abs_max_voltage if(abs_max_voltage > 0) else abs_max_current) if(mode_parameters['yscale'] is None) else float(mode_parameters['yscale'])
