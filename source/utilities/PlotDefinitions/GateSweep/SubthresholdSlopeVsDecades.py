...
def plot(deviceHistory, identifiers, mode_parameters=None):
	...
	for i in range(len(deviceHistory)):
		line = plotSubthresholdCurveSlope(ax, deviceHistory[i], colors[i], direction=mode_parameters['sweepDirection'], x_axis='drain current', absoluteXaxis=True, lineStyle=None, errorBars=mode_parameters['enableErrorBars'])
