...
def run(parameters, smu_systems, arduino_systems, share=None):
	...
	dlu.saveJSON(dlu.getDeviceDirectory(parameters), ss_parameters['saveFileName'], jsonData, subDirectory=parameters['experimentSubFolder']+str(parameters['startIndexes']['experimentNumber']))
