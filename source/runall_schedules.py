...
startDevice = "62-63"
filepath = "../../AutexysData/Nathaniel/JoeyData/schedules/run_all_bg.json" # Specifies schedule file

for device in allDevices:
	input('\n\nChange to device ' + device)
	with open(filepath) as in_file:
		with open('temp.txt', 'w') as out_file:
			out_file.write(in_file.read().replace(startDevice, device))
