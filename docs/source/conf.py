...
latex_documents = [
    (master_doc, 'Autexys.tex', 'Autexys Documentation',
     'Steven Noyce', 'manual'),
]
...
man_pages = [
    (master_doc, 'autexys', 'Autexys Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Autexys', 'Autexys Documentation',
     author, 'Autexys', 'One line description of project.',
     'Miscellaneous'),
]
